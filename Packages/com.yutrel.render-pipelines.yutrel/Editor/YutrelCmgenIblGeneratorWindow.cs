...
namespace YutrelRP.Editor
{
    ...
    {
        private const string defaultOutputDirectory = "Assets/GeneratedIBL";
        ...
        [MenuItem("Assets/Create/YutrelRP/Generate IBL with cmgen", true)]
        private static bool ValidateGenerateFromSelection()
        {
            return Selection.activeObject is Texture2D;
        }

        [MenuItem("Assets/Create/YutrelRP/Generate IBL with cmgen")]
