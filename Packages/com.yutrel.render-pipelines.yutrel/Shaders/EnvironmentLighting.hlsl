#ifndef YUTREL_ENVIRONMENT_LIGHTING_INCLUDED
...
float3 EvaluateEnvironmentDiffuseSH(float3 normal_WS)
{
...
EnvironmentLightingResult EvaluateEnvironmentLighting(
    ...
    bool specular_enabled)
{
    ...
    result.diffuse  = diffuse_lighting * surface.diffuse_color * saturate(diffuse_visibility);
    ...
    float specular_AO          = EvaluateEnvironmentSpecularAO(surface, diffuse_visibility);
